...
The transfer is not private. 21 CFR 312.23(a)(1)(viii) requires the IND cover sheet to identify any CRO, the study involved, and **a listing of the obligations transferred**; per FDA's Form 1571 instructions this listing is provided on a Continuation Page keyed to **Field 14 (Contract Research Organizations)** of [[form-fda-1571-ind-cover|Form FDA 1571]]. An amended TORO therefore triggers a 1571 information update.

Field 14 does not stand alone. FDA's instructions direct that **Field 15** name the person responsible for **monitoring** the conduct and progress of the investigation, and **Field 16** name the person responsible **under 21 CFR 312.32** for **review and evaluation of information relevant to the safety of the drug** — and that **for a Sponsor-Investigator IND the investigator personally holds both Field 15 and Field 16**. This constrains the micro-CRO model: even where monitoring *execution* (312.53(d), 312.56(a)) is transferred to the micro-CRO under Field 14, the Field 15 named monitor and the Field 16 named safety-review person on a sponsor-investigator's own IND are the sponsor-investigator. The 1571 on-form named persons and the TORO enumeration must be reconciled so the transfer of monitoring *tasks* does not misstate who holds the named monitoring/safety responsibilities of record. The causality/expectedness judgment behind Field 16 is non-delegable to the CRO (312.32) — see below.
...
> The TORO is an instrument that **reallocates federal regulatory liability between parties**, and the micro-CRO is a non-law-firm entity. Interactive-software document preparation has drawn unauthorized-practice-of-law (UPL) challenges (*Janson v. LegalZoom*; the *Parsons Technology* Texas litigation), and UPL outcomes are decided state-by-state. OSSICRO therefore ships the TORO as an **annotated template**, not finished legal work product: it validates regulatory completeness (every transferred item carries a citation; the schedule reconciles to Field 14), and micro-CRO staff review for **regulatory completeness, not legal sufficiency**. Any Tier 3 execution carries a **mandatory attorney-review** frame, and the engagement paper should state expressly that (a) OSSICRO and micro-CRO staff do not provide legal advice, (b) drafting-and-review here is regulatory, not legal, and (c) counsel must review the TORO and the service model before execution. See [[micro-cro-accountable-layer]] and [[non-delegable-functions-and-gates]].
...
- [FDA — Instructions for Filling Out Form FDA 1571 (Fields 14/15/16)](https://www.fda.gov/media/77596/download)
